...
```
    ...
    <ipython-input-3-f79c49e1cd7e> in <module>
         32     return data
         33 
    ---> 34 train_df = manipulate_data(train_df)
    

    <ipython-input-3-f79c49e1cd7e> in manipulate_data(data)
          6         data (dataframe): n_examples x m_features (int64) dataframe
          7     """
    ----> 8     data = scale_hillside(data)
          9 
         10     # Soil Combination One (based on distributions)


    NameError: name 'scale_hillside' is not defined
